...
public class Constant {
    ...
    public static final String USED_MAKE_ID = "carPickerUsed_makerSelect";

    public static final String USED_MODEL_ID = "carPickerUsed_modelSelect";

    public static final String ZIP_ID = "dealFinderZipUsedId";
